...
from model import SAM, WideResNet, Cutout, EarlyStopping

 
parser = argparse.ArgumentParser()
parser.add_argument("--adaptive", default=True, type=bool, help="Use adaptive SAM.")
parser.add_argument("--lr", default=0.125, type=float, help="Base learning rate at the start of the training.")
...
def main():
    initialize(args, path='model_testv27.pth')
