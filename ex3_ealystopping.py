...
parser.add_argument("--num_early_stop", default=3, type=int, help="Number of early stop.")
parser.add_argument("--early_stopping", default=True, type=bool, help="Use early stopping.")
...
def train(model, optimizer):
    ...
    for epoch in range(args.epochs):
        ...
        for images, labels in loop:
            ...
            F.nll_loss(model(images), labels).backward()
        ...
        print ('early_stopping.counter:', early_stopping.counter)
        ...
        if early_stopping.early_stop:
            ...
            if count > args.num_early_stop + 3:
                ...
                print(f'======Final stable stopping: {count-args.num_early_stop} of 3======')
...
def main():
    initialize(args, path='ex3_ealystopping_complex.pth')
